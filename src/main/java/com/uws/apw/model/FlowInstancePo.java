...
public class FlowInstancePo extends BaseModel {
	...
	public Dic getTaskPostionType() {
		return taskPostionType;
	}

	public void setTaskPostionType(Dic taskPostionType) {
		this.taskPostionType = taskPostionType;
	}
